      ...
      >
        <div className="h-full w-64 overflow-hidden bg-[#404040] text-[#DBDBDB] flex flex-col font-[Georgia]">
          ...
          <div className="p-4 flex justify-between items-center">
            ...
            <button onClick={onToggle} className="text-[#DBDBDB] hover:text-white">
          ...
          {/* Elements List */}
          <div className="p-4">
            <h3 className="text-center mb-2 text-[#DBDBDB] font-light">~ Elements List ~</h3>
          ...
          {/* Algorithm Selection */}
          <div className="p-4">
            <h3 className="text-center mb-2 text-[#DBDBDB] font-light">~ Algorithm ~</h3>
              ...
              <button
                className={`flex-1 p-2 rounded ${
                  selectedAlgorithm === 'BFS' 
                    ...
                    : 'bg-[#505050] text-[#DBDBDB]'
                } ${!selectedElement ? 'opacity-70' : 'hover:bg-[#606060]'} transition-colors`}
          ...
          {/* Mode Selection */}
          <div className="p-4">
            <h3 className="text-center mb-2 text-[#DBDBDB] font-light">~ Mode ~</h3>
            <button
              className={`w-full p-2 mb-2 rounded ${
                isLiveUpdateMode 
                  ? 'bg-[#DBDBDB] hover:bg-gray-300 text-black' 
                  : 'bg-[#505050] text-[#DBDBDB]'
              } ${!selectedAlgorithm ? 'opacity-70' : 'hover:bg-[#606060]'} transition-colors`}
              ...
              <button
                className={`h-full px-2 rounded ${
                  isAllSelected 
                    ? 'bg-[#DBDBDB] hover:bg-gray-300 text-black' 
                    : 'bg-[#505050] text-[#DBDBDB]'
                } ${!isMultipleRecipeMode ? 'opacity-70' : 'hover:bg-[#606060]'} transition-colors`}
